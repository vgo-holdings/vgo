export default function AboutUs() {
    return (
        <section class="py-16 bg-gray-100 font-poppins dark:bg-gray-900 min-h-screen">
            <div class="justify-center flex-1 max-w-5xl px-4 py-4 mx-auto lg:py-10 md:px-7">
                <div class="max-w-xl mx-auto">
                    <div class="text-center ">
                        <div class="relative flex flex-col items-center">
                            <div
                                class="absolute -top-24 hidden md:block  left-0 text-[120px] text-gray-400 font-bold opacity-10">
                                About Us
                            </div>
                            <h1 class="mb-16 pl-2 text-5xl font-bold border-l-8 border-orange-400 md:text-5xl dark:text-white"> Welcome to  <span class="text-orange-500"> VGO
                            </span> </h1>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative">
                    <div class="relative z-40 object-cover w-full h-full lg:rounded-tr-[80px] lg:rounded-bl-[80px] rounded bg-orange-800">
                        ...
                        <p class="p-8  mb-2 font-semibold leading-7 text-white dark:text-white">
                    ...
                    <div
                        class="absolute z-10 hidden w-full h-full bg-orange-400 rounded-bl-[80px] rounded -bottom-6 right-6 lg:block">
                    </div>
                </div>
