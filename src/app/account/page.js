    ...
    <>
      <div className="profile-container">
        ...
        >
          <div className="flex flex-col flex-1 bg-white bg-opacity-40 pt-2 rounded-md">
            <h2 className="  ml-10 mb-4 font-semibold text-center md:text-left  text-4xl">
              {user?.name}
            </h2>
            <p
          ...
          <button
            ...
            className="mt-5  ml-10 mb-4  inline-block bg-black text-white px-5 py-3 text-xs font-medium uppercase tracking-wide"
          >
            View Your Orders
          </button>
          <button
            ...
            className="mt-5  ml-10     inline-block bg-black text-white px-5 py-3 text-xs font-medium uppercase tracking-wide"
          >
            Update Profile
          </button>
          {user?.role === "freelancer" && (
      ...
      <div className="profile-dataContainer text-black ">
        <div className="bg-white shadow">
          <div className="p-6 sm:p-12 space-x-2">
            <div className=" ">
              {hideButton ? (
